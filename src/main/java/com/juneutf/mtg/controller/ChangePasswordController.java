...
public class ChangePasswordController {
	...
	public String setPassword(ChangePasswordModel changePasswordModel,Model model) {
		...
		try {
	        changePasswordModel.setId(customUser.getId());
			...
			TableModel historyModel = operationService.selectChargeHistory(changePasswordModel.getId());
			fileLogToSQL.chargeHistoryReset(historyModel,changePasswordModel.getRepassword());
			return "password/index";			
		} catch (Exception e) {
