...
/**
 * 現在の日付に基づいて、曜日を計算し表示フィールドに設定する関数fv
 */
function setDay() {
    // 曜日の日本語表記を配列で定義
...
document.getElementById('sendPlan').addEventListener('submit',function(event){
    document.getElementById('loader').innerHTML=`<div id="loadding">
    <div id="wifi-loader">
        ...
        <div class="text" data-text="予約中"></div>
    </div>
</div>`
